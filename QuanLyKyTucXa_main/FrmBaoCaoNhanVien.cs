...
namespace QuanLyKyTucXa_main
{
    public partial class FrmBaoCaoNhanVien : Form
    {
        ...
        QuanLyNhanVien_BL bll = new QuanLyNhanVien_BL();

        

        private void FrmBaoCaoNhanVien_Load(object sender, EventArgs e)
        {
            dgvNhanvien.DataSource = bll.LayDanhSachNhanVien();
        }
        ...
        private void xuấtExcelToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                worksheet.Cells[1, i + 1] = dgvNhanvien.Columns[i].HeaderText;
            }
            ...
            string endColumn = ((char)('A' + dgvNhanvien.Columns.Count - 1)).ToString(); // Ví dụ: G
